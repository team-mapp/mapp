...
import ac.smu.embedded.mapp.repository.UserFavoriteRepository
...
class DetailViewModel(
    ...
    fun loadRestaurants(userId: String, documentIds: List<String>) =
        viewModelScope.launch {
            val userFavorites = userFavoriteRepository.loadUserFavoritesAwait(userId)
    ...
    fun addFavorite(userId: String, documentId: String) =
        userFavoriteRepository.addUserFavorite(userId, documentId)

    fun removeFavorite(userId: String, documentId: String) =
        userFavoriteRepository.removeUserFavorite(userId, documentId)
}